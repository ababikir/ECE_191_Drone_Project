...
///////////////////////////////////////////////
 ...
 // The speed of the actual motors (bigger than servo)

double throttle=1300; //initial value of throttle to the motors             
float desired_angle = 0; //This is the angle in which we whant the
                         //balance to stay steady                   // Reference Frame of what they want it to be.
...
/////////////////////////////I M U/////////////////////////////////////
   ...
   * begin functions we have to put this value.*/
   ...
   // This is similar to us saying get event from LSM9DS0 (measuring acel, gyro, magnetometer)
   ...
   *part that afects the angles and ofcourse multiply by 0.98 */
   ...
   // 0.98 = filter value that they used.
